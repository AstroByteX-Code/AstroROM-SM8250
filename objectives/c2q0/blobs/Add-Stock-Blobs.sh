...
# Spen 
ADD_FROM_FW "a73" "system" "priv-app/AirCommand"
ADD_FROM_FW "stock" "system" "etc/permissions/com.sec.feature.spen_usp_level40.xml"
ADD_FROM_FW "a73" "system" "priv-app/AirReadingGlass"
